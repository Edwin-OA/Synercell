...
def main():
    ...
    if tool == 'Syngen' or tool == 'both':
        ...
        if temp == 'yes':
            ...
            genome_energy_t1 = dG_genome_T1[selected_temp]
            genome_energy_t2 = dG_genome_T2[selected_temp]
    ...
    if tool == 'both':
        ...
        G2 = ax.plot(TK, dG_genome_T1, label='Genome Block 1 Energy ', color='blue', marker='1', linewidth=2)

        G3 = ax.plot(TK, dG_genome_T2, label='Genome Block 2 Energy', color='green', marker='1', linewidth=2)
        ...
        P2 = ax.plot(TK, bio_dG_proteome_T, label='Proteome energy using biological standard energies', color='steelblue', marker='^', linewidth=2)
        ...
        results = {'Temperature': TK, 'Genome_chain':dG_genome_T, 'Genome_B1':dG_genome_T1, 'Genome_B2':dG_genome_T2, 'RNA_chain':dG_transcriptome_T,  'thermo_prot': dG_proteome_T, 'bio_prot': bio_dG_proteome_T, 'membrane': dG_membrane_T}
    ...
    if tool == 'both':
        ...
        if temp == 'yes':
            ...
            if tool == 'Synpro' or tool == 'Syngen' or tool == 'both':
                ...
                # print('Genome Chain Energy', Genome_chain_energy_data)
                # print('Genome B1 Energy', Genome_B1_energy_data)
                # print('Genome B2 Energy', Genome_B2_energy_data)
                # print('Transcriptome Chain Energy', Transcriptome_chain_energy_data)
                # print('Proteome Thermo Energy', Proteome_thermo_energy_data)
                # print('Proteome Bio Energy', Proteome_bio_energy_data)
                # print('Membrane Energy', membrane_energy_data)
                # print('Temperatures', temps_data)
