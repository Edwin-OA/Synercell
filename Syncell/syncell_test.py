...
def main():
    ...
    if tool == 'Syngen' or tool == 'both':
        ...
        # gene_list, mRNA_list = Syngen.read_genome(cell)
    ...
    if tool == 'Syngen' or tool == 'Synpro' or tool == 'both':
        ...
        ax.plot(TK, dG_membrane_T, label='Membrane energy', color='red', marker='v', linewidth=3)
        ...
        if temp == 'yes':
            ...
            if tool == 'Synpro' or tool == 'Syngen' or tool == 'both':
                ...
                Syncell = (sum(Syncell_list) * cell.cell_dry_weight) * 1000
                print('Energy to synthesie one single cell', Syncell, 'J per cell at', stemperature, 'K')
